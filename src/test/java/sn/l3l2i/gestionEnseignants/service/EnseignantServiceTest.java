...
public class EnseignantServiceTest {
    ...
    @Test
    public void testAjouterEnseignants(){



            Enseignant enseignant = new Enseignant(1L, "DIOUF", "Ngone", "dioufngone869@gmail.com");
            ...
            assertEquals("DIOUF", savedEnseignant.getNom());
    ...
    public void testTrouverEnseignantParId() {
        ...
        assertEquals("DIOUF", foundEnseignant.getNom());
