...
public class EnseignantControllerIntegrationTest {
	...
	public void testAjouterEnseignant() {
		// Arrange
		Enseignant enseignant = new Enseignant(null, "DIOUF", "Ngone", "dioufngone869@gmail.com");
		...
		assertEquals("DIOUF", response.getBody().getNom());
	}
	...
	public void testGetAllEnseignants() {
		...
		Enseignant enseignant1 = new Enseignant(null, "DIOUF", "Ngone", "dioufngone869@gmail.com");
		...
		assertEquals("DIOUF", firstEnseignant.getNom());
